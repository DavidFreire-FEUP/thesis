...
We introduce a state system to expose the resulting unconformities found during cells' processes. These unconformities are intrinsic and extrinsic, based on the historical check of trust in the variables and neighbors (respectively), and during output computation.
