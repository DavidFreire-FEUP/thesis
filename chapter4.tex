...
% TODO só fazer depois de confirmar o método com o prof
\dots


\subsection{Events}

Having a mechanism that informs the owner of relevant occurrences in his cells is one of the most critical aspects of visibility and anomaly detection in the CellTAN. For this effect, we developed something called \textbf{Events}, representing a pre-determined type of occurrence related to the cell, optionally grouped with additional information. They occur by comparing specific metrics with parametrized thresholds.
