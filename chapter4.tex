...
On cell deployment, the system expects the owner and the CellTAN manager to manually link cells together by assigning each connection. However, future work includes developing a mechanism that proposes new connections through the hub based on the neighbor's neighbors. This mechanism could function based on the strength of the relationship between cells and neighbors in common, recommending a direct link if both trust them similarly.
